  ...
  return <>
    ...
    <div className="customer-plan-grid flori-plan-grid-rc66">
      ...
      <article className="customer-plan-card business-anchor">
        ...
        <div className="customer-plan-price flori-business-price-rc610"><span className="price-prefix">valor</span><strong>Sob consulta</strong><span>definido conforme o escopo</span></div>
        <div className="customer-plan-features">
          <div><Globe2 size={17}/><span>Dominio proprio incluido</span></div>
          ...
          <div><Puzzle size={17}/><span>Modulos, automacoes e fluxos personalizados</span></div>
          <div><Headphones size={17}/><span>Acompanhamento tecnico dedicado</span></div>
        </div>
        <div className="customer-plan-footer"><span>Projeto sob medida. O valor mensal, implantacao e desenvolvimento sao definidos somente depois do levantamento do escopo.</span></div>
      </article>
    </div>
