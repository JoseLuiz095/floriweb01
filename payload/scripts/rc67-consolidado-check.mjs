...
ok('RC6.7 Meu plano trata assinatura ausente sem erro TypeScript', plan.includes('const daysOverdue = subscription?.daysOverdue ?? 0;') && plan.includes('const configuredDueDay = subscription?.dueDay ?? null;') && !plan.includes('subscription.daysOverdue') && !plan.includes('subscription.dueDay ||'));
