...
ok('Versao V3 RC6.5', packageJson.version === '3.0.0-rc.6.5');
...
ok('RC6.5 alerta mensalidade no topo', adminLayout.includes('admin-billing-status-rc65') && adminLayout.includes('Mensalidade atrasada') && adminLayout.includes('Mensalidade em dia'));
