...
export default function AdminLayout() {
  ...
  const billingStatus = useMemo(() => getBillingVisualStatus({
    billingState: subscription?.billingState,
    nextDueDate: subscription?.nextDueDate,
    dueDay: subscription?.dueDay,
    warningDays: BILLING_WARNING_DAYS,
  }), [subscription?.billingState, subscription?.nextDueDate, subscription?.dueDay]);
  const showBillingState = billingStatus.visible;
