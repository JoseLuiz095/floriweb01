...
- Estoque simples e ficha técnica ficam mais visíveis na lista de produtos.
- Recuperação, CRM e Pedir novamente recebem prazos configuráveis.
- Upsell no carrinho foi trazido para o FloriWeb.
- Mensagens operacionais, recuperação e recompra são personalizáveis com variáveis fixas.
- Pedidos ganham botão explícito para avisar o cliente pelo WhatsApp.
