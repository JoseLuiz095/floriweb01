...
type ProductRow = { id: string; store_id: string; category_id: string; name: string; slug: string; description: string; price: number | string; promotional_price: number | string | null; active: boolean; featured: boolean; made_to_order: boolean; production_days: number | null; stock_status: Product['stockStatus']; visual_emoji?: string | null };
