...
export const seedSettings: StoreSettings = {
  ...
  showPixBeforeConfirmation: true, confirmationPaymentEnabled: false, cardPaymentEnabled: true, cashPaymentEnabled: true, paymentMethodOrder: ['pix', 'card', 'cash', 'confirm'], deliveryEnabled: true, pickupEnabled: true, minimumOrder: 0, salesRecoveryEnabled:true, salesRecoveryMinutes:30, salesRecoveryWindowHours:72, crmEnabled:true, crmComeBackDays:30, repeatOrderEnabled:true, repeatOrderMaxAgeDays:120, upsellEnabled:true, upsellLimit:3, messageTemplates:{ orderCreated:'Olá, {cliente}! Seu pedido {pedido} foi registrado na {loja}. Total: {total}. Se precisar ajustar algum detalhe, responda esta mensagem.', whatsappOpened:'Olá, {cliente}! Estamos acompanhando o pedido {pedido} da {loja}. Se precisar de ajuda com entrega, presente ou cartão, fale por aqui.', cancelled:'Olá, {cliente}. O pedido {pedido} foi cancelado. Se quiser refazer ou escolher outro presente, responda esta mensagem.', salesRecovery:'Olá, {cliente}! Vimos que o pedido {pedido} na {loja}, no total de {total}, foi registrado mas o atendimento não foi concluído. Se ainda quiser finalizar seu presente, responda esta mensagem.', comeBack:'Olá, {cliente}! A {loja} está por aqui quando você quiser preparar um novo presente ou repetir uma escolha especial. Se quiser ajuda, responda esta mensagem.' },
