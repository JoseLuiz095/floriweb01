import { ArrowRight, BarChart3, Check, Flower2, Gift, Heart, MapPin, MessageCircle, PackageSearch, RefreshCw, ShieldCheck, TrendingUp, ShoppingBag, Sparkles, Store, Users } from 'lucide-react';
...
const planMarketingContent:Record<string,PlanMarketingContent>={
  ...
  PREMIUM:{
    ...
    features:[
      ...
      'CRM simples e recuperação de vendas',
      'Pedir novamente para facilitar recompra',
      'Upsell no carrinho para complementar presentes',
      'Mensagens programadas personalizáveis',
      'Estoque simples + ficha técnica interna',
...
export default function Landing(){
  ...
  return <div className="flori-sales-page flori-sales-page-v62 flori-sales-page-v63 flori-sales-page-v615">
    ...
    <main>
      ...
      <section className="flori-growth-rc617"><div className="flori-sales-heading"><span>MAIS CONTROLE, SEM VIRAR ERP</span><h2>Recursos simples para vender de novo e cuidar melhor da operação.</h2><p>O FloriWeb mantém a rotina leve, mas acrescenta informações que ajudam a decidir, recuperar oportunidades e aumentar o valor de cada pedido.</p></div><div className="flori-growth-grid-rc617"><article><PackageSearch/><h3>Estoque simples + ficha técnica</h3><p>Controle quantidade, alerta mínimo, custo estimado e uma ficha interna de composição de cada produto.</p></article><article><RefreshCw/><h3>Recuperação de vendas</h3><p>Defina quando uma oportunidade aparece, por quanto tempo fica ativa e retome o contato com mensagem personalizada.</p></article><article><Users/><h3>CRM simples + pedir novamente</h3><p>Escolha após quantos dias sugerir recompra e por quanto tempo o último pedido pode ser reconstruído.</p></article><article><TrendingUp/><h3>Upsell + mensagens da sua marca</h3><p>Sugira produtos complementares no carrinho e personalize os textos de recuperação, recompra e aviso ao cliente.</p></article></div></section>
