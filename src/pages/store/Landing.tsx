import { ArrowRight, BarChart3, Check, Flower2, Gift, Heart, MapPin, MessageCircle, PackageSearch, RefreshCw, ShieldCheck, ShoppingBag, Sparkles, Store, Users } from 'lucide-react';
...
export default function Landing(){
  ...
  return <div className="flori-sales-page flori-sales-page-v62 flori-sales-page-v63 flori-sales-page-v615">
    ...
    <main>
      ...
      <section className="flori-growth-rc617"><div className="flori-sales-heading"><span>MAIS CONTROLE, SEM VIRAR ERP</span><h2>Recursos simples para vender de novo e cuidar melhor da operação.</h2><p>O FloriWeb mantém a rotina leve, mas acrescenta informações que ajudam a decidir e a recuperar oportunidades.</p></div><div className="flori-growth-grid-rc617"><article><PackageSearch/><h3>Estoque simples + ficha técnica</h3><p>Controle quantidade, alerta mínimo, custo estimado e uma ficha interna de composição de cada produto.</p></article><article><RefreshCw/><h3>Recuperação de vendas</h3><p>Identifique pedidos que ficaram sem continuidade no WhatsApp e retome o contato com uma mensagem pronta.</p></article><article><Users/><h3>CRM simples + pedir novamente</h3><p>Acompanhe frequência e valor dos clientes recentes e facilite a recompra no dispositivo do consumidor.</p></article></div></section>
