...
ok('Versao V3 RC6.8', packageJson.version === '3.0.0-rc.6.8');
...
ok('RC6.6 alerta mensalidade verde amarelo vermelho', adminLayout.includes('admin-billing-status-rc66') && adminLayout.includes('is-warning') && adminLayout.includes('Mensalidade atrasada') && adminLayout.includes('Mensalidade em dia'));
